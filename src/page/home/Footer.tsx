      ...
      <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
        ...
        <div className="md:max-w-md lg:col-span-2">
          ...
          <div className="mt-4 lg:max-w-sm">
            <p className="text-sm">
              A real-time, team-based coding challenge platform where AI
              dynamically generates problems, evaluates submissions, and
              provides feedback. Built with TypeScript for safety,
